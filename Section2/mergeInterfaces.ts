...
interface combinedUser extends  Admin , AppUser{
...
// we can also use | for or , meaning it will either be one or the other this is also known as a union type with an interface
